...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Wow Factor: streetwear jovem e contemporâneo. Drops limitados, atitude e estilo urbano." },
      { name: "author", content: "Wow Factor" },
      { property: "og:title", content: "Wow Factor — Streetwear Jovem e Contemporâneo" },
      { property: "og:description", content: "Streetwear urbano, drops limitados e peças com atitude." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Wow Factor" },
